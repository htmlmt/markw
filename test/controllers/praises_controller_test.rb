...
class PraisesControllerTest < ActionController::TestCase
  ...
  test "should create praise" do
    assert_difference('Praise.count') do
      post :create, praise: { book_id: @praise.book_id, quotation: @praise.quotation, source: @praise.source }
    end
  ...
  test "should update praise" do
    patch :update, id: @praise, praise: { book_id: @praise.book_id, quotation: @praise.quotation, source: @praise.source }
    assert_redirected_to praise_path(assigns(:praise))
  end
