...
class InterviewsControllerTest < ActionController::TestCase
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post :create, interview: { link: @interview.link, listen: @interview.listen, snippet: @interview.snippet, title: @interview.title }
    end
  ...
  test "should update interview" do
    patch :update, id: @interview, interview: { link: @interview.link, listen: @interview.listen, snippet: @interview.snippet, title: @interview.title }
    assert_redirected_to interview_path(assigns(:interview))
  end
